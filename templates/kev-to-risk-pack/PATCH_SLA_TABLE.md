...
|---|---|---:|---|
| **7-day (Emergency)** | KEV + internet-facing (always) OR KEV marked ransomware use OR active exploitation confirmed | 7 days | VPN gateways, email servers, public web apps |
...
**Rule:** KEV + internet-facing is always 7-day. Anything that exceeds SLA requires (1) compensating controls and (2) explicit risk acceptance.
